...
args.add_argument('--use_day', default=config['data']['use_day'], type=eval)
args.add_argument('--use_week', default=config['data']['use_week'], type=eval)
args.add_argument('--use_holiday', default=config['data']['use_holiday'], type=eval)
#model
