...
class MGSTGNN(nn.Module):
    def __init__(
        ...
        self.encoder = DSTRNN(num_nodes, embed_dim+input_dim, rnn_units, embed_dim,num_grus, 12, use_back=use_back,
    ...
    def forward(self, source):
        ...
        residual = source
        source = self.linear(source)
        source = torch.cat([residual,source],dim=-1)
